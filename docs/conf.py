...
latex_documents = [
  ('index', 'Oct2Py.tex', u'Oct2Py Documentation',
   u'Oct2Py contributors', 'manual'),
]
...
man_pages = [
    ('index', 'Oct2Py', u'Oct2Py Documentation',
     [u'Oct2Py contributors'], 1)
]
...
texinfo_documents = [
  ('index', 'Oct2Py', u'Oct2Py Documentation',
   u'Oct2Py contributors', 'Oct2Py', 'GNU Octave to Python Bridge.',
   'Miscellaneous'),
]
